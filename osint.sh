...
echo "/                                                osint                                             /"
echo "+-----------+-----------+--------------+--------------+-----------------+----------+---------------+"
echo "/ sherlock  / ip lookup / phone lookup /   instakit   / lookup local db /   whois  /   enum4linux  /"   
echo "+-----------+-----------+--------------+--------------+-----------------+----------+---------------+"
echo "/     1     /     2     /       3      /       4      /        5        /     6    /        7      /"   
echo "+-----------+-----------+--------------+--------------+-----------------+----------+---------------+"
echo "choose a tool      TOOLS1 97    connection 101      TOOLS2 98          99 leave"
read tool_choice
if [ $tool_choice = 1 ]; then
    ...
    echo "mettez le dns a enumerer"
    read dns
    whois $dns
elif [ $tool_choice = 7 ]; then
    echo "mettez le dns ou l'ip a enumerer"
    read dns
    enum4linux $dns 
